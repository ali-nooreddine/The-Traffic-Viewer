...
public class Verify {
   ...
   */
  private static final String CLIENT_ID = "656990734188-8neo10p5uje3npsd701759gcr4vsvieu.apps.googleusercontent.com";
  /**
   * Replace this with the client secret you got from the Google APIs console.
   */
  private static final String CLIENT_SECRET = "rK9fy1TXvK0-I8RnvfZBL8gv";
  /**
