...
if (window.Modernizr = function(a, b, c) {
    ...
    for (var C in x)
        l(x, C) && (k = C.toLowerCase(), n[k] = x[C](), y.push((n[k] ? "" : "no-") + k));
...
}(this, this.document), "undefined" == typeof jQuery)
...
var contentPadding = 0, footerOffset = 0;
$(".content").length && (contentPadding = parseInt($(".content").css("padding-bottom").replace("px", ""))), $(window).on("scroll", function() {
    ...
    $(".content-fix-scroll").each(function(a) {
    ...
    function b(e, f, i, j) {
        ...
        function l() {
            ...
            }).on("keydown." + s.id, q), d(e, {haspopup: !0, expanded: !1, readonly: !1, owns: e.id + "_root"})
        }
        function m() {
            d(x.$root[0], "hidden", !0)
        }
        function n() {
            x.$holder.on({keydown: q, "focus.toOpen": p, blur: function() {
                ...
                var b = a(this), c = b.data(), d = b.hasClass(u.navDisabled) || b.hasClass(u.disabled), e = g();
                e = e && (e.type || e.href), (d || e && !a.contains(x.$root[0], e)) && x.$holder[0].focus(), !d && c.nav ? x.set("highlight", x.component.item.highlight, {nav: c.nav}) : !d && "pick"in c ? (x.set("select", c.pick), t.closeOnSelect && x.close(!0)) : c.clear ? (x.clear(), t.closeOnClear && x.close(!0)) : c.close && x.close(!0)
            })
        }
        function o() {
            var b;
        ...
        var r = !1, s = {id: e.id || "P" + Math.abs(~~(Math.random() * new Date))}, t = i ? a.extend(!0, {}, i.defaults, j) : j || {}, u = a.extend({}, b.klasses(), t.klass), v = a(e), w = function() {
            return this.start()
                ...
                return s.open ? x : (v.addClass(u.active), d(e, "expanded", !0), setTimeout(function() {
                    ...
                    var d = c.keyCode, e = x.component.key[d], f = c.target;
                ...
                if (d = g && a.isPlainObject(c) ? c : d || {}, b) {
                    g || (h[b] = c);
                    for (e in h)
                        f = h[e], e in x.component.item && (void 0 === f && (f = null), x.component.set(e, f, d)), ("select" == e || "clear" == e) && v.val("clear" == e ? "" : x.get(e, t.format)).trigger("change");
                    x.render()
                }
                return d.muted ? x : x.trigger("set", h)
            }, get: function(a, c) {
                if (a = a || "value", null != s[a])
                    return s[a];
                if ("valueSubmit" == a) {
                    if (x._hidden)
                        return x._hidden.value;
                    a = "value"
                }
                if ("value" == a)
                    return e.value;
                ...
                if (b) {
                    g || (h[b] = c);
                    for (e in h)
                        f = h[e], d && (e = "_" + e), s.methods[e] = s.methods[e] || [], s.methods[e].push(f)
                }
                return x
            }, off: function() {
                var a, b, c = arguments;
                for (a = 0, namesCount = c.length; namesCount > a; a += 1)
                    b = c[a], b in s.methods && delete s.methods[b];
                return x
    ...
    return a(document.documentElement), null != document.body.style.transition, b.klasses = function(a) {
        ...
        }, ariaAttr: f}, b.extend = function(c, d) {
        a.fn[c] = function(e, f) {
            var g = this.data(c);
    ...
    function c(a, b) {
        var c = this, d = a.$node[0], e = d.value, f = a.$node.data("value"), g = f ? b.formatSubmit : b.format, h = f || e, i = function() {
        ...
        }(c.item.disable), c.set("min", b.min).set("max", b.max).set("now"), h ? c.set("select", h, {format: g, defaultValue: !0}) : c.set("select", null).set("highlight", c.item.now), c.key = {40: 7, 38: -7, 39: function() {
                return i() ? -1 : 1
            }, 37: function() {
                return i() ? 1 : -1
            }, go: function(a) {
    ...
    c.prototype.set = function(a, b, c) {
        ...
        return createDayLabel = function() {
            ...
            return b
        }, f.node("div", f.node("div", createWeekdayLabel(), "picker__weekday-display") + f.node("div", q("short_months"), c.klass.month_display) + f.node("div", createDayLabel(), c.klass.day_display) + f.node("div", r("raw"), c.klass.year_display), c.klass.date_display) + f.node("div", (c.selectYears ? r() + q() : q() + r()) + p() + p(1), c.klass.header) + f.node("table", o + f.node("tbody", f.group({min: 0, max: e - 1, i: 1, node: "tr", item: function(a) {
        ...
        return{labelMonthNext: "Next month", labelMonthPrev: "Previous month", labelMonthSelect: "Select a month", labelYearSelect: "Select a year", monthsFull: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], weekdaysFull: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], weekdaysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], weekdaysLetter: ["S", "M", "T", "W", "T", "F", "S"], today: "Today", clear: "Cancel", close: "OK", closeOnClear: !0, format: "d/m/yyyy", klass: {table: a + "table", header: a + "header", date_display: a + "date-display", day_display: a + "day-display", month_display: a + "month-display", year_display: a + "year-display", calendar_container: a + "calendar-container", navPrev: a + "nav--prev icon icon-keyboard-arrow-left", navNext: a + "nav--next icon icon-keyboard-arrow-right", navDisabled: a + "nav--disabled", month: a + "month", year: a + "year", selectMonth: a + "select--month", selectYear: a + "select--year", weekdays: a + "weekday", day: a + "day", disabled: a + "day--disabled", selected: a + "day--selected", highlighted: a + "day--highlighted", now: a + "day--today", infocus: a + "day--infocus", outfocus: a + "day--outfocus", footer: a + "footer", buttonClear: a + "button--clear btn btn-flat btn-alt", buttonToday: a + "button--today btn btn-flat btn-alt", buttonClose: a + "button--close btn btn-flat btn-alt"}}
    }(a.klasses().picker + "__"), a.extend("pickadate", c)
}), $(".datepicker-adv-default").each(function(a) {
    var b = $(this).pickadate({container: "body"}), c = b.pickadate("picker");
    c.on({close: function() {
            $(document.activeElement).blur()
        }, open: function() {
            c.set("select", c.get(), {format: "d/m/yyyy"})
        }})
}), $(document).on("show.bs.dropdown", ".dropdown", function() {
    var a, b = $(".dropdown-menu", $(this)), c = $('[class*="dropdown-toggle"]', $(this)), d = $("a", b).css("padding-left").replace("px", "");
    b.length && c.length && (a = b.hasClass("dropdown-menu-right") || b.parents(".nav.pull-right").length ? c.offset().left + c.outerWidth() - d : window.innerWidth - c.offset().left - d, b.css("max-width", a))
}), $(document).keyup(function(a) {
    "27" == a.which && ($(".menu.open").length ? mReset() : $("body").hasClass("modal-open") || tReset())
}), footerPush = function() {
    $(".footer").length && $("body").css("margin-bottom", $(".footer").outerHeight())
...
}(jQuery, window, document), $(".textarea-autosize").textareaAutoSize(), getTargetFromTrigger = function(a) {
    var b, c = a.attr("data-target") || (b = a.attr("href")) && b.replace(/.*(?=#[^\s]+$)/, "");
    return c
};
var $header = $(".header"), headerHeight, headerNavMinWidth = 0;
$(window).on("scroll", function() {
    $(".header").length && (window.pageYOffset > headerHeight ? $header.addClass("fixed") : $header.removeClass("fixed"))
}), headerHeightCal = function() {
    $(".header").length && (headerHeight = $header.height())
}, $(document).on("click touchend", function(a) {
    var b = $(a.target);
    $(".menu.open").length && !b.is(".fbtn-container *, .menu-scroll *") && mReset()
}), mReset = function() {
    var a = $("body");
    a.hasClass("nav-drawer-open") && a.removeClass("nav-drawer-open"), $('[data-toggle="menu"]').closest(".active").removeClass("active"), $(".menu.open").removeClass("open")
}, $(document).on("click", '[data-toggle="menu"]', function(a) {
    a.preventDefault(), a.stopPropagation();
    var b = $(this), c = b.parent(), d = $(getTargetFromTrigger(b));
    c.hasClass("active") ? mReset() : (mReset(), d.hasClass("nav-drawer") && $("body").addClass("nav-drawer-open"), c.addClass("active"), d.addClass("open"))
    ...
    function b(a, b) {
        ...
        var c = {group: Math.random(), sort: !0, disabled: !1, store: null, handle: null, scroll: !0, scrollSensitivity: 30, scrollSpeed: 10, draggable: /[uo]l/i.test(a.nodeName) ? "li" : ">*", ghostClass: "sortable-ghost", ignore: "a, img", filter: null, animation: 0, setData: function(a, b) {
                a.setData("Text", b.textContent)
            }, dropBubble: !1, dragoverBubble: !1};
        for (var e in c)
            !(e in b) && (b[e] = c[e]);
        var f = b.group;
        f && "object" == typeof f || (f = b.group = {name: f}), ["pull", "put"].forEach(function(a) {
            a in f || (f[a] = !0)
        }), N.forEach(function(c) {
            b[c] = d(this, b[c] || O), g(a, c.substr(2).toLowerCase(), b[c])
        }, this), b.groups = " " + f.name + (f.put.join ? " " + f.put.join(" ") : "") + " ", a[G] = b;
        for (var h in this)
            "_" === h.charAt(0) && (this[h] = d(this, this[h]));
    ...
    function j(a, b, c) {
        ...
        if (d) {
            if (void 0 === c)
                return I.defaultView && I.defaultView.getComputedStyle ? c = I.defaultView.getComputedStyle(a, "") : a.currentStyle && (c = a.currentStyle), void 0 === b ? c : c[b];
    ...
    var r, s, t, u, v, w, x, y, z, A, B, C, D, E, F = {}, G = "Sortable" + (new Date).getTime(), H = window, I = H.document, J = H.parseInt, K = !!("draggable"in I.createElement("div")), L = !1, M = function(a, b, c, d, e, f) {
        var g = I.createEvent("Event");
        g.initEvent(b, !0, !0), g.item = c || a, g.from = d || a, g.clone = t, g.oldIndex = e, g.newIndex = f, a.dispatchEvent(g)
    }, N = "onAdd onUpdate onRemove onStart onEnd onFilter onSort".split(" "), O = function() {
    }, P = Math.abs, Q = [].slice, R = [], S = q(function(a, b, c) {
        if (c && b.scroll) {
    ...
    b.prototype = {constructor: b, _dragStarted: function() {
            u && r && (i(r, this.options.ghostClass, !0), b.active = this, M(u, "start", r, u, A))
        }, _onTapStart: function(a) {
            var b = a.type, c = a.touches && a.touches[0], d = (c || a).target, f = d, h = this.options, i = this.el, j = h.filter;
            if (!("mousedown" === b && 0 !== a.button || h.disabled) && (d = e(d, h.draggable, i))) {
                if (A = p(d), "function" == typeof j) {
                    if (j.call(this, a, d, this))
                        return M(f, "filter", d, i, A), void a.preventDefault()
                ...
                if ((!h.handle || e(f, h.handle, i)) && d && !r && d.parentNode === i) {
                    D = a, u = this.el, r = d, v = r.nextSibling, C = this.options.group, r.draggable = !0, h.ignore.split(",").forEach(function(a) {
                        k(d, a.trim(), l)
                    }), c && (D = {target: d, clientX: c.clientX, clientY: c.clientY}, this._onDragStart(D, "touch"), a.preventDefault()), g(I, "mouseup", this._onDrop), g(I, "touchend", this._onDrop), g(I, "touchcancel", this._onDrop), g(r, "dragend", this), g(u, "dragstart", this._onDragStart), K || this._onDragStart(D, !0);
                    try {
            ...
            if (E) {
                j(s, "display", "none");
                var a = I.elementFromPoint(E.clientX, E.clientY), b = a, c = " " + this.options.group.name, d = R.length;
                if (b)
                    do {
                        if (b[G] && b[G].groups.indexOf(c) > -1) {
                            for (; d--; )
                                R[d]({clientX: E.clientX, clientY: E.clientY, target: a, rootEl: b});
                            break
                        }
                        a = b
            ...
            if (D) {
                var b = a.touches ? a.touches[0] : a, c = b.clientX - D.clientX, d = b.clientY - D.clientY, e = a.touches ? "translate3d(" + c + "px," + d + "px,0)" : "translate(" + c + "px," + d + "px)";
            ...
            if (this._offUpEvents(), "clone" == C.pull && (t = r.cloneNode(!0), j(t, "display", "none"), u.insertBefore(t, r)), b) {
                var e, f = r.getBoundingClientRect(), h = j(r);
                ...
                c && (c.effectAllowed = "move", d.setData && d.setData.call(this, c, r)), g(I, "drop", this);
            setTimeout(this._dragStarted, 0)
        }, _onDragOver: function(a) {
            var b, d, f, g = this.el, h = this.options, i = h.group, k = i.put, l = C === i, o = h.sort;
            if (r && (void 0 !== a.preventDefault && (a.preventDefault(), !h.dragoverBubble && a.stopPropagation()), C && !h.disabled && (l ? o || (f = !u.contains(r)) : C.pull && k && (C.name === i.name || k.indexOf && ~k.indexOf(C.name))) && (void 0 === a.rootEl || a.rootEl === this.el))) {
                if (S(a, h, this.el), L)
                    return;
                if (b = e(a.target, h.draggable, g), d = r.getBoundingClientRect(), f)
                    return c(!0), void(t || v ? u.insertBefore(r, t || v) : o || u.appendChild(r));
                if (0 === g.children.length || g.children[0] === s || g === a.target && (b = n(g, a))) {
                    ...
                    y !== b && (y = b, z = j(b));
                    var p, q = b.getBoundingClientRect(), w = q.right - q.left, x = q.bottom - q.top, A = /left|right|inline/.test(z.cssFloat + z.display), B = b.offsetWidth > r.offsetWidth, D = b.offsetHeight > r.offsetHeight, E = (A ? (a.clientX - q.left) / w : (a.clientY - q.top) / x) > .5, F = b.nextElementSibling;
            ...
            for (var a, b = [], c = this.el.children, d = 0, f = c.length; f > d; d++)
                a = c[d], e(a, this.options.draggable, this.el) && b.push(a.getAttribute("data-id") || o(a));
            return b
        }, sort: function(a) {
            var b = {}, c = this.el;
        ...
        }}, b.utils = {on: g, off: h, css: j, find: k, bind: d, is: function(a, b) {
            return!!e(a, b, a)
        }, throttle: q, closest: e, toggleClass: i, dispatchEvent: M, index: p}, b.version = "1.1.1", b.create = function(a, c) {
        return new b(a, c)
    }, a.fn.sortable = function(c) {
        var d;
        return this.each(function() {
            var e = a(this), f = e.data("sortable");
...
}), $(".sortable-list").sortable({draggable: ".sortable-item", ghostClass: "sortable-ghost", handle: ".sortable-handle"}), tabSwitch = function(a, b) {
    var c = a.closest(".tab-nav"), d = $(".tab-nav-indicator", c), e = c.offset().left, f = c.width(), g = a.offset().left, h = a.outerWidth();
    null != b && b.offset().left > g && (d.addClass("reverse"), setTimeout(function() {
        d.removeClass("reverse")
    }, 450)), d.css({left: g - e, right: e + f - g - h})
    ...
    if (b.is('[data-toggle="tile"], [data-toggle="tile"] *') && !b.is('[data-ignore="tile"], [data-ignore="tile"] *')) {
        ...
        b.is('[data-dismiss="tile"]') ? b.closest(".tile-collapse").find(".tile-active-show").collapse("hide") : b.is(".tile-collapse, .tile-collapse *") || tReset();
...
}), $(".tile-wrap-animation").each(function(a) {
    var b = 0, c = 100;
    $("> .tile", $(this)).each(function(a) {
        $(this).css({"-webkit-transform": "translate(0, " + c + "%)", "-ms-transform": "translate(0, " + c + "%)", transform: "translate(0, " + c + "%)", "-webkit-transition-delay": b + "s", "transition-delay": b + "s"}), b += .1, c += 10
    })
    ...
    $(".tile-wrap-animation:not(.isinview)").each(function() {
        var a = $(this);
        tileInViewCheck(a) && (!a.hasClass("avoid-fout") || a.hasClass("avoid-fout") && a.hasClass("avoid-fout-done")) && (!a.hasClass("el-loading") || a.hasClass("el-loading") && a.hasClass("el-loading-done")) && !a.parents(".avoid-fout:not(.avoid-fout-done)").length && !a.parents(".el-loading:not(.el-loading-done)").length && a.addClass("isinview")
    })
}, tileInViewCheck = function(a) {
    a = a[0];
    var b = a.getBoundingClientRect();
    return b.top <= window.innerHeight && b.right >= 0 && b.bottom >= 0 && b.left <= window.innerWidth
};
var toastTimeout;
$('[data-toggle="toast"]').tooltip({animation: !1, container: ".toast", html: !0, placement: "bottom", template: '<div class="tooltip"><div class="toast-inner tooltip-inner"></div></div>', trigger: "manual"}), $(document).on("click", '[data-dismiss="toast"]', function(a) {
    a.preventDefault(), toastHide(0)
}), toastHide = function(a, b) {
    clearTimeout(toastTimeout), toastTimeout = setTimeout(function() {
        $(".toast").removeClass("toast-show"), $(".fbtn-container").length && $(".fbtn-container").css("margin-bottom", ""), $(".toast-inner").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function(a) {
            $(".toast-toggled").tooltip("hide").removeClass("toast-toggled"), null !== b && void 0 !== b ? b.tooltip("show").addClass("toast-toggled") : $(".toast").remove()
        })
    }, a)
    ...
    var a = $(this);
    $(".toast").length || $("body").append('<div class="toast"></div>'), a.hasClass("toast-toggled") || ($(".toast").hasClass("toast-show") ? toastHide(0, a) : a.tooltip("show").addClass("toast-toggled"))
}), $(document).on("shown.bs.tooltip", '[data-toggle="toast"]', function() {
    $(this);
    $(".toast").addClass("toast-show"), $(window).width() < 768 && $(".fbtn-container").length && $(".fbtn-container").css("margin-bottom", $(".toast").outerHeight()), $(".toast-inner").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend", function(a) {
        toastHide(6e3)
    })
}), !function(a, b) {
    "use strict";
    ...
    var g = g || {}, h = document.querySelectorAll.bind(document), i = {duration: 750, show: function(a, b) {
            if (2 === a.button)
                return!1;
            ...
            0 > l && (l = 0), setTimeout(function() {
                var a = {top: g + "px", left: f + "px", opacity: "0", "-webkit-transition-duration": i.duration + "ms", "-moz-transition-duration": i.duration + "ms", "-o-transition-duration": i.duration + "ms", "transition-duration": i.duration + "ms", "-webkit-transform": h, "-moz-transform": h, "-ms-transform": h, "-o-transform": h, transform: h};
        ...
        }}, j = {touches: 0, allowEvent: function(a) {
            var b = !0;
...
}), Waves.displayEffect({duration: 900}), WebFontConfig = {classes: !1, fontactive: function() {
        $(".avoid-fout").each(function(a) {
            $(this).addClass("avoid-fout-done")
        }), contentFixPushCal(), footerPush(), headerHeightCal(), $(".tab-nav").each(function() {
    ...
    }, google: {families: ["Roboto:300,300italic,400,400italic,700,700italic"]}}, function() {
    var a = document.createElement("script");
    a.src = ("https:" == document.location.protocol ? "https" : "http") + "://ajax.googleapis.com/ajax/libs/webfont/1.5.18/webfont.js", a.type = "text/javascript", a.async = "true";
    var b = document.getElementsByTagName("script")[0];
    b.parentNode.insertBefore(a, b)
}(), on_resize = function(a, b) {
    return onresize = function() {
        clearTimeout(b), b = setTimeout(a, 100)
    }, a
}, on_resize(function() {
    contentFixPushCal(), footerPush(), headerHeightCal(), $(".header-nav-scroll").length && headerNavPos(), $(".tab-nav").each(function() {
        tabSwitch($(".nav > li.active", $(this)), null)
